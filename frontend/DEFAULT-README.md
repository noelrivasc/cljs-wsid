...
* [`src/wsid/`](src/wsid/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/wsid/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `wsid` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/wsid/config.cljs) defaults to `true` in
